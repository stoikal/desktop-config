...
-- Rename active workspace (i3-style)
hl.bind(mainMod .. " + N", hl.dsp.exec_cmd(bin .. "/rename-workspace.sh"))

-- Scroll through existing workspaces with mainMod + scroll
hl.bind(mainMod .. " + mouse_down", hl.dsp.focus({ workspace = "e+1" }))
hl.bind(mainMod .. " + mouse_up",   hl.dsp.focus({ workspace = "e-1" }))

-- Switch to previous/next existing workspace with mainMod + Ctrl + arrow keys
...
hl.layer_rule({
    ...
    animations = {
        enter = { enabled = true, speed = 8, bezier = "easeOutQuint", style = "fade" },
        leave = { enabled = true, speed = 4, bezier = "linear",       style = "fade" },
    },
})
